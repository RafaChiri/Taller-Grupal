# Rúbrica de evaluación: taller BFS, DFS y A*

| Criterio | Puntaje | Descripción |
|---|---:|---|
| Representación del problema | 15 | Define correctamente grafo o mapa, inicio, meta y obstáculos. |
| Implementación de BFS | 15 | Usa cola, visitados, padres y reconstrucción de camino. |
| Implementación de DFS | 15 | Usa pila, visitados, padres y reconoce que no garantiza camino corto. |
| Implementación de A* | 20 | Usa cola de prioridad, costo acumulado y heurística Manhattan. |
